package com.jeniapp.jenisoft.myapplication;
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            for(Beacon beacon : beaconList) {
                textView.append("UUID: " + beacon.getId1());

                    String Str1 = "74278bda-1234-5678-8f0c-720eaf059935";
                    if (beacon.getId1().toString().equals(Str1)) {
                        textView.append("\n 확인완료료" + Double.parseDouble(String.format("%.3f", beacon.getDistance())));


                        if (beacon.getDistance() < 1) {
                            textView.append("알림시작" + "\n ");
